...
const SendFeedback = ({ sidebar }) => {
  ...
  return (
    <div className="min-h-screen ml-10 mt-[100px] py-3">
      <div
        className={`flex gap-2 mt-[2px] mb-8 relative pt-1 group-focus-within:border-black ${
      ...
      <div className="py-[10px] gap-3">
        <div className="w-[600px] mb-10">
          {" "}
          {/* Tăng khoảng cách dưới lên */}
          <Input
            className="rounded-sm outline-black hover:border-black border-gray-300 py-[9px]"
            placeholder="Email Address"
          />
        </div>
        <div className="w-[600px] hover:border-black">
          <TextArea
            className="rounded-sm outline-black hover:border-black focus:border-black border-gray-300 py-[11px] px-[14px]"
            rows={4}
      ...
      <button className=" mt-12 rounded-[3px] px-[20px] py-[12px]  bg-red-600 outline-none hover:bg-[#333333] text-white text-[14px] font-medium ">
        Send Feedback
      </button>
    </div>
  );
